...
# Explicit allowed transitions (idempotent: same→same allowed)
_TRANSITIONS: dict[PipelineStage, set[PipelineStage]] = {
  ...
  PipelineStage.SEO_ENRICH_PENDING: {PipelineStage.PUBLISHING, PipelineStage.FAILED_RETRYABLE},
  PipelineStage.PUBLISHING: {
    PipelineStage.PUBLISHED_DRAFT,
    PipelineStage.FAILED_RETRYABLE,
    PipelineStage.FAILED_TERMINAL,
  },
  PipelineStage.PUBLISHED_DRAFT: set(),
  PipelineStage.FAILED_RETRYABLE: {PipelineStage.QUEUED, PipelineStage.FAILED_TERMINAL},
