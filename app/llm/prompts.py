...
TOPIC_CLEANUP_V1 = "topic_cleanup_v1"

TOPIC_CLEANUP_V1_SYSTEM = """?? ???????? ???????-????????? ??? B2B CRM-??????? (Bitrix24, CRM, ???????, ??????????).
?????? ??????????? ???? ??? SEO ? ????????. ??????? ?????? ???????? JSON ??? markdown."""

TOPIC_CLEANUP_V1_USER = """?? ????? ? ???????? ?????????? ??? (deterministic) ? ???????? ??????.

????? JSON:
- primary_topic (string): ???? ????? ???? ??????
- secondary_topics (array of strings): 2-6 ????, ?? ????????? ????????? ?????
...
- project_fit (string): crmflow24 ??? ??????
- rejected_terms (array of strings): ???????? ???????
- warnings (array of strings)
- strategy_allowed (boolean): false ??? smoke/test/internal/?????????????
...
???????:
- ?? ????????? ????????? ??????????????/?????.
- ???? title/content ???????? smoke test, ????????, ???????, mock, placeholder, debug ? strategy_allowed=false, strategy_block_reason=smoke_test ??? internal_test.
- ???? ???? ?? ??? CRM/???????/?????????? ? strategy_allowed=false.
- JSON only.
